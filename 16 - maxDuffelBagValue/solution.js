/*
Write a function maxDuffelBagValue() that takes an 
array of cake type objects and a weight capacity, and 
returns the maximum monetary value the duffel bag can hold.
*/

// time / space
// O(n*k) / O(k), n = number of cakes, k equal capacity of bag
        ...
        for (var j = 0; j < cakeTypes.length; j++) {
            ...
            if (cakeType.weight <= currentCapacity) {
                ...
                var maxValueUsingCake =
                    cakeType.value + maxValuesAtCapacities[currentCapacity - cakeType.weight];
 ...
 * sometimes you may want a fast and good answer, not necessarily
 * the slower but most optimal one